...
--
-- Database: `u994453189_MarketSphere`
--
...
(1, 'Australia', 'B', 'img/2_australia.jpeg', 6999.99, 'Discover the wonders of Australia, a vast and diverse continent, where ancient landscapes, vibrant cities, and unique wildlife converge in a breathtaking tapestry of natural beauty and cultural richness.', 71, 8, 2, '4', 3),
(2, 'Caribbean', 'B', 'img/2_caribbean.jpeg', 2999.99, 'Sail into the captivating allure of the Caribbean, a tropical paradise where turquoise waters, white-sand beaches, and vibrant cultures create an idyllic escape for sun-seekers and adventure enthusiasts alike.', 40, 0, 0, '0', 0),
(3, 'Thailand', 'B', 'img/3_Thailand.jpeg', 1499.99, 'Thailand, a mesmerizing blend of vibrant urban life, cultural treasures, and tropical paradises, invites visitors to explore its dynamic cities, ancient temples, and pristine beaches.', 17, 12, 7, '1.7142857142857', 4),
(4, 'Dubai', 'B', 'img/2_dubai.jpeg', 5499.99, 'Dive into the opulence of Dubai, a cosmopolitan city and emirate renowned for its iconic skyline, luxury shopping, and cultural richness. Explore the intersection of tradition and modernity in this vibrant destination.', 32, 3, 3, '1', 1),
(5, 'Hawaii', 'B', 'img/2_hawaii.jpeg', 2249.99, 'Immerse yourself in the allure of Hawaii, where the rhythmic waves meet volcanic landscapes, creating a Pacific paradise that beckons with vibrant traditions, breathtaking scenery, and the spirit of aloha.', 37, 13, 3, '4.3333333333333', 3),
(6, 'India', 'B', 'img/1_India.jpeg', 2499.99, 'Embark on a journey through India, a land of diverse cultures, ancient traditions, and vibrant landscapes, where the echoes of history harmonize with the kaleidoscope of colors, flavors, and spiritual richness.', 49, 15, 8, '1.875', 7),
(7, 'Italy', 'B', 'img/2_italy.jpeg', 5999.99, 'Indulge in the timeless charm of Italy, a Mediterranean masterpiece where ancient history, sumptuous cuisine, and architectural wonders intertwine, inviting travelers to savor la dolce vita.', 42, 10, 2, '5', 2),
(8, 'Las Vegas', 'B', 'img/2_lasvegas.jpeg', 1999.99, 'Experience the exhilarating allure of Las Vegas, where dazzling lights, world-class entertainment, and high-stakes excitement come together in the entertainment capital of the world.', 26, 5, 1, '5', 1),
(9, 'London', 'B', 'img/2_london.jpeg', 4499.99, 'Embark on a journey through London, a timeless metropolis where iconic landmarks, rich history, and cosmopolitan vibrancy blend seamlessly, offering a captivating tapestry of cultural diversity and urban sophistication.', 15, 5, 4, '1.25', 1),
(10, 'Singapore', 'B', 'img/2_singapore.jpeg', 1999.99, 'Singapore, a futuristic metropolis blending innovation with cultural diversity, offers a unique experience with iconic architecture, lush greenery, and a dynamic culinary scene.', 32, 4, 1, '4', 1),
(11, 'Pain Relievers', 'A', 'img/pain1.jpeg', 60.00, 'Over-the-counter pain relievers like acetaminophen or ibuprofen can help relieve pain and reduce fever. Follow the recommended dosages and guidelines.', 51, 4, 1, '4', 1),
(12, 'Disposable Gloves', 'A', 'img/gloves1.jpeg', 45.99, 'Disposable latex or nitrile gloves are essential for protecting both the person administering first aid and the injured person. They help maintain cleanliness and reduce the risk of infection.', 40, 5, 1, '5', 1),
(13, 'Adhesive Tapes', 'A', 'img/tape1.jpeg', 20.00, 'Medical tape is used to secure dressings and bandages in place. It is hypoallergenic and gentle on the skin. There are various types, including paper tape and cloth tape.', 18, 5, 1, '5', 1),
(14, 'Adhesive Bandages', 'A', 'img/bandage1.jpeg', 19.99, 'Adhesive bandages are small, sterile strips with an adhesive backing. They are used to cover and protect minor cuts, blisters, and abrasions. They come in various sizes, including standard and fingertip sizes.', 35, 6, 2, '3', 3),
(15, 'Antiseptic Wipes', 'A', 'img/wipes1.jpeg', 29.99, 'Antiseptic wipes or solutions contain disinfectants like alcohol or iodine to clean wounds and prevent infection. They are used before applying bandages or dressings.', 28, 4, 1, '4', 1),
(16, 'Scissors', 'A', 'img/scissors1.jpeg', 49.99, 'Small, sharp scissors with rounded tips are useful for cutting tape, clothing, or gauze. They should be included to safely remove clothing near wounds or to trim materials as needed.', 38, 5, 2, '2.5', 2),
(17, 'CPR Masks', 'A', 'img/mask1.jpeg', 20.00, 'CPR face shield or mask provides a barrier between the rescuer and the person receiving CPR, preventing the exchange of bodily fluids and offering protection during resuscitation.', 38, 5, 1, '5', 2),
(18, 'Tweezers', 'A', 'img/tweezers1.jpeg', 15.00, 'Fine-point tweezers are used to remove splinters, glass, or other foreign objects from the skin. They provide precision for safe removal.', 31, 10, 2, '5', 2),
(19, 'Emergency blanket', 'A', 'img/blanket1.jpeg', 35.00, 'An emergency blanket, is a lightweight, compact, and reflective blanket that helps retain body heat. It\'s crucial for staying warm in emergency situations or extreme weather.', 15, 9, 2, '4.5', 2),
(20, 'Eyewash or Saline Solution', 'A', 'img/eyewash1.jpeg', 49.99, 'Saline solution is used for rinsing the eyes in case of foreign object or chemical exposure. It helps flush out irritants and is essential for eye safety.', 26, 10, 2, '5', 2),
(21, 'Luxury Villa in Prime Location', 'C', 'img/3_property1.jpg', 65999.99, 'Explore this exquisite luxury villa located in a prime residential area. This spacious property features modern amenities, beautiful landscaping, and stunning views. It\'s the perfect place to call home.', 30, 9, 2, '4.5', 1),
(22, 'A Lavish Mansion in an Exclusive Locale', 'C', 'img/3_property2.jpg', 82999.99, 'Discover this magnificent luxury villa situated in an upscale residential district. With contemporary conveniences, picturesque gardens, and breathtaking vistas, it\'s an ideal haven for your next home.', 33, 0, 0, '0', 0),
(23, 'A Stylish Estate in a Coveted Location', 'C', 'img/3_property3.jpg', 94999.99, 'Experience an exceptional luxury villa in a prestigious residential enclave. This expansive estate boasts state-of-the-art facilities, meticulously landscaped grounds, and awe-inspiring panoramas. It\'s a dream residence waiting for you.', 34, 3, 1, '3', 1),
(24, 'A Sophisticated Property in Desirable Area', 'C', 'img/3_property4.jpg', 45999.99, 'Uncover an opulent luxury villa located in the heart of an exclusive residential community. Featuring cutting-edge amenities, meticulously manicured gardens, and panoramic vistas, it\'s a haven that defines the essence of home.', 31, 0, 0, '0', 1),
(25, 'A Grand Retreat in a Superb Locale', 'C', 'img/3_property5.jpg', 88999.99, 'Embark on a journey to explore this sumptuous luxury villa positioned in a sought-after residential neighborhood. With contemporary luxuries, lush greenery, and captivating scenery, it\'s an idyllic place to call your own.', 24, 3, 1, '3', 1),
(26, 'A Magnificent Adobe in the Heart of Elegance', 'C', 'img/3_property6.jpg', 98987.99, 'Witness the allure of this grand luxury villa located in an upscale residential haven. Encompassing modern features, meticulously designed gardens, and mesmerizing vistas, it\'s the epitome of a dream home.', 30, 5, 1, '5', 0),
(27, 'A Sumptuous Homestead in an Ideal Spot', 'C', 'img/3_property7.jpg', 55999.99, 'Dive into the charm of this regal luxury villa within a prestigious residential zone. This remarkable estate boasts state-of-the-art conveniences, meticulously tended gardens, and captivating views. It\'s a place you\'ll never want to leave.', 33, 4, 1, '4', 1),
(28, 'An Elegant Estate in Coveted Location', 'C', 'img/3_property8.jpg', 88999.99, 'Immerse yourself in the elegance of this sophisticated luxury villa situated in a prime residential neighborhood. Modern amenities, enchanting outdoor spaces, and breathtaking views make it the ultimate dwelling.', 39, 5, 1, '5', 1),
(29, 'A Regal Dwelling Amidst Luxury and Convenienc', 'C', 'img/3_property9.jpg', 78999.99, 'Enter the world of this serene luxury villa located in an exclusive residential locale. With contemporary comforts, meticulously crafted outdoor areas, and awe-inspiring scenery, it offers the perfect blend of elegance and tranquility.', 50, 5, 1, '5', 1),
(30, 'A Serene Residence in Highly Sought -  After ', 'C', 'img/3_property10.jpg', 48999.99, 'Venture into this splendid luxury villa nestled in an esteemed residential area. The property offers contemporary amenities, beautifully landscaped grounds, and mesmerizing views. It\'s a residence like no other.', 39, 0, 0, '0', 0),
(31, 'Innovation on Wheels: The Audi Experience', 'D', 'img/4_audi.jpeg', 49580.00, 'Audi is a German automobile manufacturer that is part of the Volkswagen Group. The company was founded in 1910, and its headquarters are located in Ingolstadt, Germany. Audi produces a wide range of luxury vehicles, including sedans, coupes, SUVs.', 36, 0, 0, '0', 1),
